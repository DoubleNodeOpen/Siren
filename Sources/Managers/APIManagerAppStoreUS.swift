...
public class APIManagerAppStoreUS: APIManager {
    /// Constants used in the `APIManagerAppStoreUS`.
    ...
    /// Convenience initializer that initializes `APIManagerAppStoreUS` to the region or country of an App Store in which the app is available.
